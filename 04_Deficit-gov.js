(function () {
    ...
    myConnector.getData = function (table, doneCallback) {
      let url = 'http://ec.europa.eu/eurostat/wdds/rest/data/v2.1/json/en/teina205?na_item=B9&precision=1&unit=PC_GDP_SCA&sector=S13';
    ...
    $(document).ready(function () {
      $('#submitButton').click(function () {
        tableau.connectionName = '04_Deficit-gov'; // This will be the data source name in Tableau
