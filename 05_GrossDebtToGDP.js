(function () {
    ...
    myConnector.getData = function (table, doneCallback) {
      let url = 'http://ec.europa.eu/eurostat/wdds/rest/data/v2.1/json/en/teina230?na_item=GD&precision=1&unit=PC_GDP&sector=S13';
    ...
    $(document).ready(function () {
      $('#submitButton').click(function () {
        tableau.connectionName = '05_GrossDebtToGDP'; // This will be the data source name in Tableau
