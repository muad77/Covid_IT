(function () {
    ...
    myConnector.getData = function (table, doneCallback) {
      let url = 'http://ec.europa.eu/eurostat/wdds/rest/data/v2.1/json/en/tipsex13?na_item=P6&precision=1&unit=CLV_PCH_PRE';
    ...
    $(document).ready(function () {
      $('#submitButton').click(function () {
        tableau.connectionName = '09_ExportShare'; // This will be the data source name in Tableau
