(function () {
    ...
    myConnector.getData = function (table, doneCallback) {
      let url = 'http://ec.europa.eu/eurostat/wdds/rest/data/v2.1/json/en/teibs010?indic=BS-ESI-I&precision=1&s_adj=SA';
    ...
    $(document).ready(function () {
      $('#submitButton').click(function () {
        tableau.connectionName = '12_IndexSentiment'; // This will be the data source name in Tableau
