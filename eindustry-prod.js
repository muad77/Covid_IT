(function () {
    ...
    myConnector.getData = function (table, doneCallback) {
      let url = 'http://ec.europa.eu/eurostat/wdds/rest/data/v2.1/json/en/teiis090?precision=1&unit=PCH_M12_CA&unit=PCH_M1_SCA&indic_bt=PROD&nace_r2=C';
    ...
    $(document).ready(function () {
      $('#submitButton').click(function () {
        tableau.connectionName = 'eindustry-prod'; // This will be the data source name in Tableau
