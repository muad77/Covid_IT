(function () {
    ...
    myConnector.getData = function (table, doneCallback) {
      let url = 'http://ec.europa.eu/eurostat/wdds/rest/data/v2.1/json/en/teina011?na_item=B1GQ&precision=1&unit=PCH_Q4_SCA';
    ...
    $(document).ready(function () {
      $('#submitButton').click(function () {
        tableau.connectionName = 'gdp'; // This will be the data source name in Tableau
