(function () {
    ...
    myConnector.getData = function (table, doneCallback) {
      let url = 'http://ec.europa.eu/eurostat/wdds/rest/data/v2.1/json/en/tipsgo20?na_item=GD&precision=1&unit=MIO_NAC&unit=PC_GDP&sector=S13';
    ...
    $(document).ready(function () {
      $('#submitButton').click(function () {
        tableau.connectionName = 'gross-debt'; // This will be the data source name in Tableau
